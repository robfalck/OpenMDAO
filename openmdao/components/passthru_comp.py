...
class PassthruComp(ExplicitComponent):
    """
    Duplicate an input as an output
    ...
    **kwargs : dict
    ...
    def add_var(self, name, val=1.0, shape=None, output_name=None, src_indices=None, flat_src_indices=None,
