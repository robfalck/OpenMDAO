...
from openmdao.utils.jax_utils import jax, jit, jnp, \
    _jax_register_pytree_class, _compute_sparsity, _compute_sparsity_asdex, _asdex_available, _declare_partials_from_asdex, _asdex_can_pay_off, get_vmap_tangents, \
