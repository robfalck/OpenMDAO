...
class TestSqliteRecorder(unittest.TestCase):
    ...
    def test_simple_driver_recording(self):
        ...
        assertDriverDerivDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps)
    ...
    def test_simple_driver_recording_with_prefix(self):
        ...
        assertDriverIterDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps, prefix='Run1')

        expected_data = (
            (run2_coord, (run2_t0, run2_t1), expected_outputs, expected_inputs, None),
        )
        assertDriverIterDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps, prefix='Run2')
        ...
        assertDriverDerivDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps, prefix='Run1')
    ...
    def test_record_system(self):
        ...
        assertSystemIterDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps, prefix='Run#2')
    ...
    def test_record_solver(self):
        ...
        expected_data = ((coordinate, (t0, t1), expected_abs_error, expected_rel_error,
                          expected_solver_output, expected_solver_residuals),)
        assertSolverIterDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_data, self.eps, prefix='run_again')
    ...
    def test_record_driver_system_solver(self):
        ...
        assertSystemIterDataRecorded(self, prob.get_outputs_dir() / self.filename, expected_system_data, self.eps)
...
class TestFeatureAdvancedExample(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # build the model
        prob = self.prob = om.Problem(model=SellarMDAWithUnits())
    ...
    def test_feature_system_recorder(self):
        ...
        # Instantiate your CaseReader
        cr = om.CaseReader(self.prob.get_outputs_dir() / "cases.sql")
...
class TestFeatureBasicRecording(unittest.TestCase):
    ...
    def record_cases(self):
        ...
        prob = self.prob = om.Problem(model=SellarMDA())
